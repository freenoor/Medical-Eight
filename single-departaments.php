...
<div class="contact-welcome" style="background-image: url(<?php the_field('banner-foto',19);?>)">
...
<div class="container-fluid pini">
     ...
     <div class="container-fluid pini1">
        <div class="homeposthometexttt">
            <div class="imgfoto-departments">
                <?php the_post_thumbnail(); ?>
            </div>
            <div class="departments-single-content">
                <h2><?php the_field('content_title'); ?></h2>
                <h3><?php the_field('content_description'); ?></h3>
                <p><?php the_content(); ?></p>
            </div>
        </div>
     </div>
